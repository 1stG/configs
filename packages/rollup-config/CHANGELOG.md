...
* **rollup-config:** remove outdated rollup plugins, add jsox back ([aefa304](https://github.com/1stG/configs/commit/aefa304))





## [0.11.7](https://github.com/1stG/configs/compare/@1stg/rollup-config@0.11.6...@1stg/rollup-config@0.11.7) (2019-09-28)


### Bug Fixes

* **rollup-config:** add node-globals for node-builtins ([f26993a](https://github.com/1stG/configs/commit/f26993a))





## [0.11.6](https://github.com/1stG/configs/compare/@1stg/rollup-config@0.11.5...@1stg/rollup-config@0.11.6) (2019-09-28)


### Bug Fixes

* **rollup-config:** add sourceMap config, dedupe for non node env ([6295c70](https://github.com/1stG/configs/commit/6295c70))
...
* **rollup-config:** try to resolve alias find as RegExp automatically :tada: ([645798c](https://github.com/1stG/configs/commit/645798c))
...
* **rollup-config:** resolve assets automatically, add url plugin support ([7f523fb](https://github.com/1stG/configs/commit/7f523fb))
